...
class WalletReportSummaryTab(QWidget):
    ...
    def __init__(self, db_manager, parent=None):
        ...
        self.signal_manager.pocket_changed.connect(self.on_data_changed)
        self.signal_manager.category_changed.connect(self.on_data_changed)
        self.init_ui()
        self.load_data()
    ...
    def on_data_changed(self):
        """Auto-refresh filter data and report when pocket/category changes."""
