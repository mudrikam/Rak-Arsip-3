...
class WalletReportByPocketTab(QWidget):
    """Report showing transactions grouped by pocket."""
    ...
    def init_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Pocket", "Type", "Transactions", "Total Amount", "Currency"])
    ...
    def load_filter_data(self):
        ...
        self.filter_widget.pocket_combo.setEnabled(False)
    ...
    def load_data(self):
        try:
            ...
            data = wallet_helper.get_transactions_by_pocket(
                filters['date_from'],
                filters['date_to'],
            ...
            for row_data in paginated_data:
                ...
                pocket_name = row_data.get('pocket_name', 'Unknown')
                ...
                self.table.setItem(row, 0, QTableWidgetItem(pocket_name))
            ...
            print(f"Error loading by pocket report: {e}")
            QMessageBox.critical(self, "Error", f"Failed to load report: {str(e)}")
    
    def export_csv(self):
        try:
            headers = ["Pocket", "Type", "Transactions", "Total Amount", "Currency"]
            data = []
    ...
    def export_pdf(self):
        try:
            ...
            if WalletReportExporter.export_to_pdf(data, headers, "Wallet Report by Pocket", filters, parent=self):
